<div id="wp-menu">
    <menu>
        ...
        <a href="<?= SITE ?>app/perfil.php" class="sub">Sobre</a>
        <div class="sub">
        ...
        <a href="<?= SITE ?>app/servicos/avaliacao-psicologica.php" class="sub">Serviços</a>
        <div class="sub">
            ...
            <a href="<?= SITE ?>app/servicos/orientacao-psicoeducacao.php">Orientação / Psicoeducação</a>
            <a href="<?= SITE ?>app/servicos/supervisao.php">Supervisão</a>
            <a href="<?= SITE ?>app/servicos/cursos.php">Cursos</a>
        </div>
        <a href="<?= SITE ?>app/blog/index.php" class="sub">Blog</a>
        <div class="sub">
